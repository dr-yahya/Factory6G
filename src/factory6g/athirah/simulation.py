...
from factory6g.athirah.polar.init_pc import init_pc
from factory6g.athirah.polar.pencode import pencode
from factory6g.athirah.scma.encoder import scmaenc
from factory6g.athirah.ofdm.pilot import add_pilot, remove_pilot
from factory6g.athirah.ofdm.cp import add_cp, remove_cp
from factory6g.athirah.estimation.mmse_ce import mmse_ce
from factory6g.athirah.estimation.ls_ce import ls_ce
from factory6g.athirah.jidd import jidd
...
def run_jidd_scma(cfg: dict, data_dir: str, ce_method: str | None = None) -> dict:
    ...
    Args:
        ...
        data_dir: Path to directory containing polar code .txt files and
                  the SCMA codebook .mat file (i.e. 'reference/dr_athirah_simulation/PHY layer').
