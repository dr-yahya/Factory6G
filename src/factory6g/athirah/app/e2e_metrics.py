...
def run_app_fec_sim(
    ...
    """
    from factory6g.athirah.app.raptor_q import load_raptor_q_table, raptor_q_prr_overhead
    from factory6g.athirah.app.repetition import load_repetition_table, repetition_prr_overhead
